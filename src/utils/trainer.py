...
class Trainer:
    ...
    def save_checkpoint(self,string):
        ...
        print(f"save model {self.config.ckpt_path.replace('.pt',f'-{string}.pt')}")
        torch.save(self.model, self.config.ckpt_path.replace('.pt',f"-{string}.pt"))
    ...
    def train(self, wandb):
        ...
        for epoch in range(config.max_epochs):
            ...
            if self.config.ckpt_path is not None and good_model:
                ...
                self.save_checkpoint(string=str(epoch))
